        ...
        for queue_name in self.queues:
            ...
            try:
                ...
                for job_id in ready_job_ids:
                    ...
                    reservation: SocketReservation | None = None
                    try:
            ...
            with span_cm as span:
                try:
                    ...
                    if outcome.status == "success":
                        ...
                        error_type = (
                            outcome.error.type if outcome.error is not None else None
                        )
                        if error_type == "handler_not_found":
                            logger.error(
